...
if (isset($_GET['id'])) {
    # code...
    $sel_category = select_one_category_controller($_GET['id']);
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Update Category Form</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                ...
                                <form action="../Actions/add_category.php" method="post" id="category-form">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="id" value="<?php if (isset($_GET['id'])) {
                                                echo $sel_category['cat_id'];
                                            }?>">
                                            <input type="text" class="form-control" placeholder="category Name" value="<?php if (isset($_GET['id'])) {
                                                echo $sel_category['cat_name'];
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-block" name="update_category">Update </button>
                                        </div>
