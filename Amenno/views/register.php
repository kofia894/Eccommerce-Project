...
<div class="login-form">
    <form action="registerprocess.php" method="post" id="form">
        ...
        <div class="form-group">
            <input type="text" class="form-control" id = "country" placeholder="Country"  name="ctry">
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-block"  name="add_user"> Sign Up</button>
        </div>
        <div class="clearfix">
